...
export default function Sidebar() {
    ...
    return (
        /* Strictly hidden on mobile screens (< 768px), rendered only on desktop */
        <aside className="fixed left-0 top-0 h-full w-[280px] bg-surface border-r border-outline-variant/20 shadow-md flex-col p-md z-40 hidden md:flex">
            <Link href="/" className="mb-3xl px-sm cursor-pointer block">
            ...
            <div className="mt-auto space-y-sm border-t border-outline-variant/20 pt-md">
                ...
                <Link href="/help" className="flex items-center gap-3 text-on-surface-variant hover:bg-surface-container-low rounded-xl px-4 py-2 transition-colors">
                ...
                {user ? (
                    ...
                    <Link href="/auth" className="flex items-center gap-3 text-primary hover:bg-surface-container-low rounded-xl px-4 py-2 transition-colors">
